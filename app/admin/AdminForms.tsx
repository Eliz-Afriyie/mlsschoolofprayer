...
export default function AdminForms() {
  ...
  const [devotionalState, devotionalAction, devotionalPending] = useActionState(
    createDevotional,
    initialState
  );
    ...
    <div className="grid gap-8 lg:grid-cols-2">
      ...
      >
        ...
        <div className="grid gap-4">
          ...
          <Message state={devotionalState} />
          <button
            type="submit"
            disabled={devotionalPending}
          ...
          >
            <Upload size={18} />
            {devotionalPending ? "Uploading..." : "Upload Devotional"}
          </button>
        </div>
      </form>
      ...
      >
        ...
        <div className="grid gap-4">
          ...
          >
            <Upload size={18} />
            {bookPending ? "Uploading..." : "Upload Book"}
          </button>
        </div>
      </form>
    </div>
